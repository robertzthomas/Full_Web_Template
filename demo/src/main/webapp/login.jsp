...
<div class="header_section header_main" style="background-image: url('images/abstract2.png')">
  <div class="container">
    <div class="row">
      <div class="col-sm-3">
...
<div class="layout_padding contact_section">
  <div class="container">
    <h1 class="new_text">
      <strong id="loginLabel">Sign In</strong>
    </h1>
  </div>
            ...
            <div class="container">
              <form style="display: inline-block">
                ...
                <div class="form-group">
                  <input id="password" type="text" class="email-bt" placeholder="Password" name="Password" style="display: none">
                </div>
              </form>
              <div style="display: inline-block; position: relative">
                <button id="signInButton" class="main_bt">Sign In</button>
                <p id="newMember" style="color: white">New Member?</p>
                <button id="signUpButton"class="main_bt" onclick="setLoginVerbiage();">Sign Up</button>
              </div>
            </div>
...
<script>
  function setLoginVerbiage(){
    let text = document.getElementById("loginLabel").textContent;
    document.getElementById("loginLabel").textContent = "Sign Up";
    document.getElementById("password").setAttribute('style', '');
    document.getElementById("signInButton").setAttribute('style','display : none;');
    document.getElementById("newMember").setAttribute('style', 'display: none;');
  }
</script>
</body>
</html>
