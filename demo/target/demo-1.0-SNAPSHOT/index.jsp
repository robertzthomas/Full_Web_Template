                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="banner_taital">
                                            <h1 class="banner_text">New Men's Chelsea </h1>
                                            <h1 class="mens_text"><strong style="font-family: Garamond;">PAR HASARD I</strong></h1>
                                            <p class="lorem_text">Par Hassard<br>Noun<br>1. a possibility of something happening.<br><br>2. the occurrence and development of events in the absence of any obvious design."</p>
